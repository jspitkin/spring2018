...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        """
        self.particles = [self.legalPositions[i % len(self.legalPositions)] for \
            i in range(self.numParticles)]
    ...
    def observe(self, observation, gameState):
        ...
        for p in self.legalPositions:
            trueDistance = util.manhattanDistance(p, pacmanPosition)
            beliefDistribution[p] *= emissionModel[trueDistance]
    ...
    def elapseTime(self, gameState):
        ...
        for index, particle in enumerate(self.particles):
            ...
            self.particles[index] = util.sample(newPosDist)
...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        self.particles = [ghostPos[i % len(ghostPos)] for i in range(self.numParticles)]
